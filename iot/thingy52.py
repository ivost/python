...
def main():
    ...
    parser.add_argument('-t',action='store',type=float, default=20.0, help='time between polling')
    ...
    parser.add_argument('--battery', action='store_true', default=True)
    ...
    try:
        ...
        if args.gas:
            thingy.environment.enable()
            thingy.environment.configure(gas_mode_int=interval)
